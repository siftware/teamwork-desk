...
use Mockery as m;
use NigelHeap\Teamwork\Factory;
...
class FactoryTest extends PHPUnit_Framework_TestCase {
    ...
    {
        parent::setUp();
        $this->requestable = m::mock('NigelHeap\TeamworkDesk\Contracts\RequestableInterface');
    }
    ...
    public function test_that_it_returns_new_account_object()
    {
        ...
        $this->assertInstanceOf('NigelHeap\TeamworkDesk\Account', $factory->account());
    }

    /**
     * @group factory
     * @expectedException NigelHeap\TeamworkDesk\Exceptions\ClassNotCreatedException
     */
